...
public class Class_4f2 extends Project {
   ...
   public void sub_6ac(Graphics var1, int var2, int var3, int var4) {
      ...
      int var7 = var2 + var4 - GameScreen.gameScreen.rangItemsArr[this.sub_18d(28)].someStr.length() * 5 - 5;
      GameScreen.gameScreen.sub_fcf(var1, var7, var6, GameScreen.gameScreen.rangItemsArr[this.sub_18d(28)].someStr, GameScreen.gameScreen.rMiniFront2Img);
      var6 += 8;
      String var5 = this.sub_18d(12) + "-" + GameScreen.gameScreen.staminaItemsArr[this.sub_18d(20)].someStr;
      ...
      var6 += 8;
      var5 = this.sub_18d(0) + "-" + GameScreen.gameScreen.costumeItemsArr[this.sub_18d(8)].someStr;
      var7 = var2 + var4 - var5.length() * 5 - 5;
      GameScreen.gameScreen.sub_fcf(var1, var7, var6, var5, GameScreen.gameScreen.rMiniFront2Img);
      GameScreen.gameScreen.sub_fcf(var1, var2 + 7, var6, SomeUtilClass.getStr("БРОНЯ") + ":", GameScreen.gameScreen.rMiniFrontImg);
      var6 += 8;
      var5 = GameScreen.gameScreen.attackSpeedItemsArr[this.sub_18d(24)].someStr;
      var7 = var2 + var4 - var5.length() * 5 - 5;
      GameScreen.gameScreen.sub_fcf(var1, var7, var6, var5, GameScreen.gameScreen.rMiniFront2Img);
      GameScreen.gameScreen.sub_fcf(var1, var2 + 7, var6, SomeUtilClass.getStr("БОЕПРИПАСЫ") + ":", GameScreen.gameScreen.rMiniFrontImg);
      var6 += 8;
      var5 = this.sub_400() + "-" + GameScreen.gameScreen.weaponItemsArr[this.sub_3a5()].someStr;
      var7 = var2 + var4 - var5.length() * 5 - 5;
      GameScreen.gameScreen.sub_fcf(var1, var7, var6, var5, GameScreen.gameScreen.rMiniFront2Img);
