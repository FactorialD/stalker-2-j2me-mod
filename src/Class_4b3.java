...
public class Class_4b3 {
	public static final int UPGRADE_WINDOW_WIDTH = 118;
	...
	public static final int BASE_MENU_Y_POS = 49;

	public static int PLANET_INFO_MENU_BG_COLOR = 5909268;
	...
	public Class_4b3(int menuId, int xPos, int yPos, int var4, int windowHeight, int var6, Planet planet) {
		this.xPos = xPos;
		this.yPos = yPos;
		this.var_124 = var4;
		...
		switch (this.menuId) {
		case 1: // planet view
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("ЗАКРЫТЬ").length() * 8) / 2,
					this.yPos + windowHeight - 15, SomeUtilClass.getStr("ЗАКРЫТЬ"), true);
			curYPos = this.yPos + 15;
			if (this.somePlanet != null) {
				this.var_26e = this.somePlanet.sub_96();
				this.addMenu2Option(this.xPos + 13, curYPos, SomeUtilClass.getStr("ХАБАР:"), false);
				this.addMenu2Option(this.xPos + 66, curYPos, "" + this.somePlanet.sub_1a4(), false);
				curYPos += 7;
				this.addMenu2Option(this.xPos + 13, curYPos, SomeUtilClass.getStr("ТЕХНИКА:"), false);
				this.addMenu2Option(this.xPos + 66, curYPos, "" + this.somePlanet.sub_1d1(), false);
				curYPos += 7;
				this.addMenu2Option(this.xPos + 13, curYPos, SomeUtilClass.getStr("НАУКА:"), false);
				this.addMenu2Option(this.xPos + 66, curYPos, "" + this.somePlanet.sub_224(), false);
				curYPos += 7;
				curYPos += 5;
				this.addMenu2Option(this.xPos + 13, curYPos, SomeUtilClass.getStr("НАСЕЛЕНИЕ:"), false);
				this.addMenu2Option(this.xPos + 66, curYPos, "" + this.somePlanet.sub_248(), false);
				curYPos += 7;
			}
		...
		case 2: // pause menu
			this.var_5d4 = false;
			curYPos = this.yPos + 8;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("ХОД").length() * 8) / 2, curYPos,
					SomeUtilClass.getStr("ХОД"), true);
			curYPos += 10;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("КАРТА").length() * 8) / 2, curYPos,
					SomeUtilClass.getStr("КАРТА"), true);
			curYPos += 10;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("ОТРЯДЫ").length() * 8) / 2, curYPos,
					SomeUtilClass.getStr("ОТРЯДЫ"), true);
			curYPos += 10;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("НАУКА").length() * 8) / 2, curYPos,
					SomeUtilClass.getStr("НАУКА"), true);
			curYPos += 10;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("ЭКИПИРОВКА").length() * 8) / 2, curYPos,
					SomeUtilClass.getStr("ЭКИПИРОВКА"), true);
			curYPos += 10;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("НАЛОГ").length() * 8) / 2, curYPos,
					SomeUtilClass.getStr("НАЛОГ"), true);
			curYPos += 10;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("СИЛА ГРУППИРОВОК").length() * 8) / 2, curYPos,
					SomeUtilClass.getStr("СИЛА ГРУППИРОВОК"), true);
			curYPos += 10;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("ВЫХОД").length() * 8) / 2 - 1, curYPos,
					SomeUtilClass.getStr("ВЫХОД"), true);
			curYPos += 10;
			this.var_e5a = 2;
			break;
		case 3:
			this.addMenu2Option(this.xPos + (var4 - SomeUtilClass.getStr("ЭКИПИРОВКА").length() * 8) / 2, this.yPos + 4,
					SomeUtilClass.getStr("ЭКИПИРОВКА"), true);
		...
		case 5: // create colony menu
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("ДА").length() * 8) / 2,
					this.yPos + windowHeight - 25, SomeUtilClass.getStr("ДА"), true);
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("НЕТ").length() * 8) / 2,
					this.yPos + windowHeight - 15, SomeUtilClass.getStr("НЕТ"), true);
			curYPos = this.yPos + 15;
			if (this.somePlanet != null) {
				this.addMenu2Option(this.xPos + 13 + 10, curYPos, SomeUtilClass.getStr("ХАБАР"), false);
				this.addMenu2Option(this.xPos + 66 + 10, curYPos, "" + this.somePlanet.sub_1a4(), false);
				curYPos += 7;
				this.addMenu2Option(this.xPos + 13 + 10, curYPos, SomeUtilClass.getStr("ТЕХНИКА:"), false);
				this.addMenu2Option(this.xPos + 66 + 10, curYPos, "" + this.somePlanet.sub_1d1(), false);
				curYPos += 7;
				this.addMenu2Option(this.xPos + 13 + 10, curYPos, SomeUtilClass.getStr("НАУКА:"), false);
				this.addMenu2Option(this.xPos + 66 + 10, curYPos, "" + this.somePlanet.sub_224(), false);
				curYPos += 7;
				curYPos += 5;
				this.addMenu2Option(this.xPos + 13 + 10, curYPos, SomeUtilClass.getStr("НАСЕЛЕНИЕ:"), false);
				this.addMenu2Option(this.xPos + 66 + 10, curYPos, "" + this.somePlanet.sub_248(), false);
				curYPos += 7;
			}

			this.addMenu2Option(this.xPos + (var4 - SomeUtilClass.getStr("ОСНОВАТЬ ЛАГЕРЬ").length() * 8) / 2 - 2,
					this.yPos + 5, SomeUtilClass.getStr("ОСНОВАТЬ ЛАГЕРЬ"), true);
			this.var_e5a = 15;
			break;
		case 6:
			this.var_124 = 82;
			...
			this.addMenu1Option(this.xPos + (this.var_124 - SomeUtilClass.getStr("ЗАКРЫТЬ").length() * 8) / 2,
					this.yPos + this.windowHeight - 15, SomeUtilClass.getStr("ЗАКРЫТЬ"), true);
			break;
		case 7:
			try {
		...
		case 8:
			this.var_5d4 = false;
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("ИССЛЕДОВАТЬ").length() * 8) / 2,
					this.yPos + windowHeight - 22, SomeUtilClass.getStr("ИССЛЕДОВАТЬ"), true);
			this.addMenu1Option(this.xPos + (var4 - SomeUtilClass.getStr("ОТМЕНА").length() * 8) / 2 - 2,
					this.yPos + windowHeight - 12, SomeUtilClass.getStr("ОТМЕНА"), true);
			break;
		case 9:
			try {
		...
		case 11:
			...
			int var9 = this.xPos + (this.var_124 - SomeUtilClass.getStr("СМЕНИТЬ ЭКИПИРОВКУ").length() * 8) / 2;
			this.addMenu1Option(var9, curYPos, SomeUtilClass.getStr("СМЕНИТЬ ЭКИПИРОВКУ"), true);
			curYPos += 10;
		...
		case 12:
			...
			this.xPos = (GameScreen.gameScreen.getWidth() - this.var_124) / 2;
			this.yPos = (GameScreen.gameScreen.getHeight() - this.windowHeight) / 2;
			this.addMenu1Option(this.xPos + (this.var_124 - SomeUtilClass.getStr("ДА").length() * 8) / 2,
					this.yPos + this.windowHeight - 22, SomeUtilClass.getStr("ДА"), true);
			this.addMenu1Option(this.xPos + (this.var_124 - SomeUtilClass.getStr("НЕТ").length() * 8) / 2,
					this.yPos + this.windowHeight - 12, SomeUtilClass.getStr("НЕТ"), true);
			break;
		case 13:
			this.var_53a = GameScreen.gameScreen.var_d5c;
		...
		case 14:
			...
			this.xPos = (GameScreen.gameScreen.getWidth() - this.var_124) / 2;
			this.yPos = (GameScreen.gameScreen.getHeight() - this.windowHeight) / 2;
			this.addMenu1Option(this.xPos + (this.var_124 - SomeUtilClass.getStr("ОК").length() * 8) / 2,
					this.yPos + this.windowHeight - 15, SomeUtilClass.getStr("ОК"), true);
			break;
		case 15:
			try {
				if (Stars.var_b9) {
		...
		case 20:
			this.addMenu1Option(this.xPos + (this.var_124 - SomeUtilClass.getStr("ЗАКРЫТЬ").length() * 8) / 2,
					this.yPos + this.windowHeight - 15, SomeUtilClass.getStr("ЗАКРЫТЬ"), true);
			this.addMenu1Option(this.xPos + (this.var_124 - SomeUtilClass.getStr("ДАЛЕЕ").length() * 8) / 2,
					this.yPos + this.windowHeight - 15, SomeUtilClass.getStr("ДАЛЕЕ"), true);
			this.var_3c8 = 0;
			break;
		case 21:
			this.addMenu1Option(this.xPos + 6, this.yPos + this.windowHeight - 15 - 22, SomeUtilClass.getStr("МУЗЫКА"),
					true);
			this.addMenu1Option(this.xPos + 6, this.yPos + this.windowHeight - 15 - 11,
					SomeUtilClass.getStr("ВИБРАЦИЯ"), true);
			this.addMenu1Option(this.xPos + (this.var_124 - SomeUtilClass.getStr("ЗАКРЫТЬ").length() * 8) / 2,
					this.yPos + this.windowHeight - 15, SomeUtilClass.getStr("ЗАКРЫТЬ"), true);
		}
	...
	public void sub_108(Graphics g) {
		...
		default:
			if (this.var_c7c != this.var_1f3) {
				if (this.var_5d4) {
					GameScreen.gameScreen.sub_114f(g, this.xPos, this.yPos, this.var_1f3, this.windowHeight,
							this.var_221, this.var_43b);
				} else {
					GameScreen.gameScreen.sub_114f(g, this.xPos, this.yPos, this.var_124, this.var_1f3, this.var_221,
							this.var_43b);
				}
				...
				if (this.var_c28 == null) {
					...
					GameScreen.gameScreen.sub_114f(this.var_c28.getGraphics(), 0, 0, this.var_124, this.windowHeight,
							this.var_221, this.var_43b);
				}
				...
				if (this.menuOptions2Arr != null) {
					for (var3 = 0; var3 < this.menuOptions2Arr.size(); ++var3) {
						...
						if (this.var_3c8 == var3) {
							...
							g.setColor(4013373);
							g.drawLine(this.xPos + 5 + this.var_124 - 10, var2.yPos + 2,
									this.xPos + 5 + this.var_124 - 10, var2.yPos + 8);
							if (this.menuId == 3) {
								this.sub_134(g);
							}
						}
						...
						if (this.menuId == 20) {
							...
							if (var2.var_2f) {
								...
								GameScreen.gameScreen.sub_fcf(g, var2.xPos, var2.yPos, var2.str,
										GameScreen.gameScreen.rMiniFrontImg);
							}
						}
					}
				}
				...
				if (this.menuOptions1Arr != null) {
					for (var3 = 0; var3 < this.menuOptions1Arr.size(); ++var3) {
						...
						if (var2.var_2f) {
							...
							GameScreen.gameScreen.sub_fcf(g, var2.xPos, var2.yPos, var2.str,
									GameScreen.gameScreen.rMiniFront2Img);
						}
					}
				}
				...
				if (this.var_26e != "") {
					...
					var10000.sub_fcf(g, var10002 + (var10003 - var10004 * 5) / 2, this.yPos + 4, this.var_26e,
							GameScreen.gameScreen.rMiniFront2Img);
				}

				if (this.menuId == 21) {
					String var7 = SomeUtilClass.getStr("НАСТРОЙКИ");
					GameScreen.gameScreen.drawFancyText(g, this.xPos + (this.var_124 - var7.length() * 8) / 2,
							this.yPos + 5, var7, this.var_42f);
				}
	...
	public void sub_134(Graphics var1) {
		...
		GameScreen.gameScreen.sub_240c(var1, this.xPos + 5, this.yPos + 15, var2, this.var_53a.var_1c6, 30, false,
				(Image) null);
		int var3 = this.yPos + 17;
		GameScreen.gameScreen.sub_fcf(var1, this.xPos + 37, var3, SomeUtilClass.getStr("АТАКА") + ":",
				GameScreen.gameScreen.rMiniFront2Img);
		GameScreen.gameScreen.sub_fcf(var1, this.xPos + 37 + 47, var3,
				"" + this.var_53a.projectsArr[this.var_3c8].sub_582(), GameScreen.gameScreen.rMiniFront2Img);
		var3 += 7;
		GameScreen.gameScreen.sub_fcf(var1, this.xPos + 37, var3, SomeUtilClass.getStr("ЗАЩИТА") + ":",
				GameScreen.gameScreen.rMiniFront2Img);
		GameScreen.gameScreen.sub_fcf(var1, this.xPos + 37 + 47, var3,
				"" + this.var_53a.projectsArr[this.var_3c8].sub_53b(), GameScreen.gameScreen.rMiniFront2Img);
		var3 += 7;
		GameScreen.gameScreen.sub_fcf(var1, this.xPos + 37, var3, SomeUtilClass.getStr("БОЕПРИПАСЫ") + ":",
				GameScreen.gameScreen.rMiniFront2Img);
		GameScreen.gameScreen.sub_fcf(var1, this.xPos + 37 + 47, var3,
				"" + this.var_53a.projectsArr[this.var_3c8].sub_530(), GameScreen.gameScreen.rMiniFront2Img);
		var3 += 7;
		GameScreen.gameScreen.sub_fcf(var1, this.xPos + 37, var3, SomeUtilClass.getStr("ЦЕНА") + ": ",
				GameScreen.gameScreen.rMiniFront2Img);
		GameScreen.gameScreen.sub_fcf(var1, this.xPos + 37 + 47, var3,
				"" + this.var_53a.projectsArr[this.var_3c8].sub_601(this.var_53a.var_1c6),
				GameScreen.gameScreen.rMiniFront2Img);
	}
	...
	public void sub_197() {
		if (this.var_79a != null) {
			...
			if (this.menuId == 7) {
				if (this.var_3c8 == 0) {
					this.var_4f8 = GameScreen.gameScreen.sub_8b2(this.somePlanet);
				} else {
					if (this.var_3c8 == 1) {
						this.somePlanet.var_1df.sub_190();
					}

					if (this.var_3c8 == 2) {
						this.somePlanet.var_1df.sub_1a0();
					}

					if (this.var_3c8 == 3) {
						this.somePlanet.var_1df.sub_1ca();
					}
	...
	public void sub_1ea() {
		if (this.var_79a != null) {
			...
			if (this.menuId == 7) {
				if (this.var_3c8 == 0) {
					this.var_4f8 = GameScreen.gameScreen.sub_8e6(this.somePlanet);
				} else {
					if (this.var_3c8 == 1 && this.somePlanet.var_1df.sub_249() > 0) {
						this.somePlanet.var_1df.sub_36(this.somePlanet.var_1df.sub_249() - 1);
					}

					if (this.var_3c8 == 2 && this.somePlanet.var_1df.sub_27d() > 0) {
						this.somePlanet.var_1df.sub_4b(this.somePlanet.var_1df.sub_27d() - 1);
					}

					if (this.var_3c8 == 3 && this.somePlanet.var_1df.sub_28a() > 0) {
						this.somePlanet.var_1df.sub_92(this.somePlanet.var_1df.sub_28a() - 1);
					}
	...
	public boolean sub_23d(Graphics var1) {
		if (this.menuId != 4 || this.var_3c8 != 2 && this.var_3c8 != 3 && this.var_3c8 != 5) {
			...
			var10004 = GameScreen.gameScreen;
			GameScreen.gameScreen.sub_fcf(var1, var10002, var10003 - 5 - 2, SomeUtilClass.getStr("УМН.УВЛ"),
					GameScreen.gameScreen.rMiniFront2Img);
			return true;
		}
	}
	...
	public void sub_2e2(Graphics g) {
		if (this.var_4f8 != null) {
			this.somePlanet = this.var_4f8;
			this.var_4f8 = null;
			this.var_b2b = 0;
			GameScreen.gameScreen.someXCellPos = this.somePlanet.getXAbsoluteSector();
			GameScreen.gameScreen.someYCellPos = this.somePlanet.getYAbsoluteSector();
		}
		...
		if (this.var_b03) {
			...
			if (this.var_ab3 == var2) {
				this.var_b64 = this.somePlanet.drawColonyStatistics(g, this.var_b2b, 15, this.var_124 - 30,
						this.var_ab3 - 20, this.var_124 > 140);
				g.setStrokeStyle(0);
			} else {
				this.var_b64 = false;
				this.var_b2b = 0;
	...
	public void sub_2fc(Graphics g) {
		int var2 = 7;
        int curYPos = BASE_MENU_Y_POS;

		if (this.var_124 < 150) {
			var2 = (this.var_124 - this.colBtnImg.getWidth()) / 2;
		}

		char populationIncomeSign = '+';
		if (this.somePlanet.getPopulationIncome() < 0) {
			populationIncomeSign = '-';
		}

		String populationStr;
		for (populationStr = "" + this.somePlanet.var_1df.var_141; populationStr.length() < 3; populationStr = "0" + populationStr) {
		}

		populationStr = SomeUtilClass.getStr("НАСЕЛЕНИЕ ЛАГЕРЯ") + ":" + this.somePlanet.var_1df.getCurrentPopulation() + "." + populationStr + "(" + populationIncomeSign
				+ Math.abs(this.somePlanet.getPopulationIncome()) + ")";
		GameScreen.gameScreen.sub_fcf(g, var2, this.windowHeight - 22, populationStr, GameScreen.gameScreen.rMiniFront2Img);
		this.drawBaseMenuOptionFrame(g, var2, curYPos);
		this.sub_3a3(g, var2 + 5, curYPos + 2, 0, this.var_3c8 == 1);
		this.sub_3fa(g, var2 + 7 + 16, curYPos + 2, 45, this.somePlanet.var_1df.sub_249(), 0);
		this.sub_3c7(g, var2 + 89, curYPos + 1, 0, this.somePlanet.sub_2c2(), true);
		curYPos += 20;
		this.drawBaseMenuOptionFrame(g, var2, curYPos);
		this.sub_3a3(g, var2 + 5, curYPos + 2, 1, this.var_3c8 == 2);
		this.sub_3fa(g, var2 + 7 + 16, curYPos + 2, 45, this.somePlanet.var_1df.sub_27d(), 1);
		this.sub_3c7(g, var2 + 89, curYPos + 1, 1, this.somePlanet.sub_35d(GameScreen.gameScreen.var_d5c), true);
		curYPos += 20;
		this.drawBaseMenuOptionFrame(g, var2, curYPos);
		this.sub_3a3(g, var2 + 5, curYPos + 2, 2, this.var_3c8 == 3);
		this.sub_3fa(g, var2 + 7 + 16, curYPos + 2, 45, this.somePlanet.var_1df.sub_28a(), 2);
		this.sub_3c7(g, var2 + 89, curYPos + 1, 2, this.somePlanet.sub_36e(GameScreen.gameScreen.var_d5c), true);
		curYPos += 20;
		this.drawBaseMenuOptionFrame(g, var2, curYPos);
		this.sub_3c7(g, var2 + 89 - 14 - 3, curYPos + 2, 3, this.somePlanet.sub_391(GameScreen.gameScreen.var_d5c),
				true);
		this.sub_3c7(g, var2 + 89 - 3, curYPos + 1, 4 + this.somePlanet.var_1df.sub_483(), 0, false);
		this.sub_3fa(g, var2 + 7, curYPos + 2, 42, this.somePlanet.var_1df.sub_341(), 3);

		for (int var6 = 0; var6 < SomeUtilClass.var_19.length
				&& this.somePlanet.var_1df.var_19d >= var6 * 100; ++var6) {
			g.setColor(SomeUtilClass.var_19[var6]);
			g.drawLine(var2 + 101, curYPos + 12 - var6, var2 + 101, curYPos + 12 - var6);
		}

		curYPos += 20;
		g.drawImage(this.colBuildImg, var2 + 71, curYPos, 20);
		this.sub_318(g, var2 + 71, curYPos);
		populationStr = this.somePlanet.var_1df.sub_402(this.somePlanet.var_1df.jobId,
				this.somePlanet.sub_35d(GameScreen.gameScreen.var_d5c)) + "Х";
		GameScreen var10000 = GameScreen.gameScreen;
		int var10002 = var2 + 71;
		int var10003 = this.colBuildImg.getWidth();
		int var10004 = populationStr.length();
		GameScreen var10005 = GameScreen.gameScreen;
		var10002 += (var10003 - var10004 * 5) / 2;
		var10003 = curYPos + this.colBuildImg.getHeight();
		var10000.sub_fcf(g, var10002, var10003 - 5 * 2, populationStr, GameScreen.gameScreen.rMiniFront2Img);
		this.sub_3a3(g, var2 + 5, curYPos + 2, 3, this.var_3c8 == 4);
		GameScreen.gameScreen.drawFancyText(g, var2 + 5 + 17, curYPos + 6, "СТРОИТ", this.var_42f);
		if (this.windowHeight <= 160) {
			curYPos += 20;
		} else {
			curYPos += 22;
		...
		GameScreen.gameScreen.drawFancyText(g, var2 + 71 - this.somePlanet.var_1df.getJobName().length() * 8 - 8,
				curYPos, this.somePlanet.var_1df.getJobName(), this.var_42f);
	}

	public void sub_318(Graphics var1, int var2, int var3) {
		if (this.somePlanet.var_1df.jobId == 255) {
			var1.drawImage(this.rHouseImg, var2 + 15, var3 + 13, 20);
			this.sub_3fa(var1, var2 + 8, var3 + 10, 20, 1, 3);
		}

		if (this.somePlanet.var_1df.jobId == 511) {
			this.sub_3c7(var1, var2 + 11, var3 + 9, 3, 0, false);
		}

		if (this.somePlanet.var_1df.jobId == 767) {
			GameScreen.gameScreen.sub_240c(var1, var2, var3, 5, GameScreen.gameScreen.var_d5c.var_1c6, 35, false,
					(Image) null);
		}

		if (this.somePlanet.var_1df.jobId >= 4095) {
			GameScreen.gameScreen.sub_240c(var1, var2, var3,
					GameScreen.gameScreen.var_d5c.projectsArr[this.somePlanet.var_1df.jobId - 4095].sub_18d(28),
					GameScreen.gameScreen.var_d5c.var_1c6, 35, false, (Image) null);
		}
	...
	public void drawBaseMenuOptionFrame(Graphics g, int xPos, int yPos) {
		g.setClip(xPos, yPos, 5, this.colBtnImg.getHeight());
		g.drawImage(this.colBtnImg, xPos, yPos, 20);
		g.setClip(xPos, yPos, this.colBtnImg.getWidth(), 2);
		g.drawImage(this.colBtnImg, xPos, yPos, 20);
		g.setClip(xPos, yPos + this.colBtnImg.getHeight() - 2, this.colBtnImg.getWidth(), 2);
		g.drawImage(this.colBtnImg, xPos, yPos, 20);
		g.setClip(xPos + this.colBtnImg.getWidth() - 5, yPos, 5, this.colBtnImg.getHeight());
		g.drawImage(this.colBtnImg, xPos, yPos, 20);
		g.setClip(0, 0, this.var_124, this.windowHeight);
	}

	public void drawSomeScienceMenuRows(Graphics g, int xPos, int yPos, int var4, int var5) {
		if (this.colBtnImg != null) {
			boolean var6 = true;
			g.setClip(xPos, yPos, 30, 1);
			g.drawImage(this.colBtnImg, xPos, yPos, 20);

			int var8;
			for (var8 = xPos + 30; var8 <= xPos + var4 - 30; var8 += 5) {
				g.setClip(var8, yPos, 5, 1);
				g.drawImage(this.colBtnImg, var8 - 30, yPos, 20);
			}

			var8 = xPos + var4 - 30;
			g.setClip(var8, yPos, 30, 1);
			g.drawImage(this.colBtnImg, var8 - this.colBtnImg.getWidth() + 30, yPos, 20);
			g.setClip(xPos, yPos + 1, 4, 10);
			g.drawImage(this.colBtnImg, xPos, yPos, 20);
			g.setClip(xPos + var4 - 4, yPos + 1, 4, 10);
			g.drawImage(this.colBtnImg, xPos - this.colBtnImg.getWidth() + var4, yPos, 20);
			g.setClip(xPos, yPos + var5 - 6, 4, 5);
			g.drawImage(this.colBtnImg, xPos, yPos + var5 - this.colBtnImg.getHeight(), 20);
			g.setClip(xPos + var4 - 4, yPos + var5 - 6, 4, 5);
			g.drawImage(this.colBtnImg, xPos - this.colBtnImg.getWidth() + var4,
					yPos + var5 - this.colBtnImg.getHeight(), 20);

			int var7;
			for (var7 = yPos + 10; var7 < yPos + var5 - 6; var7 += 2) {
				g.setClip(xPos, var7, 4, 2);
				g.drawImage(this.colBtnImg, xPos, var7 - 10, 20);
				g.setClip(xPos + var4 - 4, var7, 4, 2);
				g.drawImage(this.colBtnImg, xPos - this.colBtnImg.getWidth() + var4, var7 - 10, 20);
			}

			var7 = yPos + var5 - 1;
			g.setClip(xPos, var7, 30, 2);
			g.drawImage(this.colBtnImg, xPos, var7 - this.colBtnImg.getHeight() + 2, 20);

			for (var8 = xPos + 30; var8 <= xPos + var4 - 30; var8 += 5) {
				g.setClip(var8, var7, 5, 2);
				g.drawImage(this.colBtnImg, var8 - 30, var7 - this.colBtnImg.getHeight() + 2, 20);
			}

			var8 = xPos + var4 - 30;
			g.setClip(var8, var7, 30, 2);
			g.drawImage(this.colBtnImg, var8 - this.colBtnImg.getWidth() + 30, var7 - this.colBtnImg.getHeight() + 2,
					20);
			g.setClip(0, 0, this.var_124, this.windowHeight);
		}
	}
	...
	public void sub_3c7(Graphics g, int xPos, int yPos, int var4, int var5, boolean var6) {
		g.setClip(xPos, yPos, 14, 14);
		if (var4 == 10) {
			if (this.rShipImg != null) {
				g.drawImage(this.rShipImg, xPos, yPos + 4, 20);
			}
		} else {
			g.drawImage(this.colPicImg, xPos - var4 * 14, yPos, 20);
		}
		...
		if (var6) {
			...
			GameScreen.gameScreen.drawFancyText(g, xPos - var7.length() * 8 - 2, yPos + 5, var7, this.var_42f);
		}
	...
	public void sub_442(Graphics var1, int var2, int var3) {
		...
		var4 = (this.var_124 - this.somePlanet.sub_96().length() * 8) / 2;
		GameScreen.gameScreen.drawFancyText(var1, var4, var3, this.somePlanet.sub_96(), this.var_42f);
	}
	...
	public void sub_505() {
		if (this.somePlanet.var_1df.jobId != 255 && this.somePlanet.var_1df.jobId != 511) {
			int var1 = this.somePlanet.var_1df.sub_385();
			if (GameScreen.gameScreen.var_d5c.var_f6 < var1) {
				...
				this.var_b77.var_26e = this.somePlanet.var_1df.getJobName();
				this.var_b77.addMenu2Option(-1, this.var_b77.yPos + 14, SomeUtilClass.getStr("ДЛЯ ПОКУПКИ"), false);
				this.var_b77.addMenu2Option(-1, this.var_b77.yPos + 14 + 7, SomeUtilClass.getStr("НАДО ") + var1 + "MК",
						false);
			} else {
				...
				this.var_b77.addMenu2Option(-1, this.var_b77.yPos + 22, SomeUtilClass.getStr("ЗА") + var1 + "МК" + "?",
						false);
			}
		}
	}
	...
	public void drawColonyInfoBg(Graphics var1, int var2, int var3, int var4, int var5) {
		var1.setColor(this.PLANET_INFO_MENU_BG_COLOR);
	...
	public void sub_593(Graphics var1) {
		...
		for (var6 = 0; var6 < GameScreen.gameScreen.planetsArr.size(); ++var6) {
			...
			if (var5 != 16777215) {
				this.sub_639(var1, var7 + var9.getXAbsoluteSector() * this.var_efa,
						var8 + var9.getYAbsoluteSector() * this.var_efa, var5, this.var_efa,
						var9.getXAbsoluteSector() == GameScreen.gameScreen.someXCellPos
								&& var9.getYAbsoluteSector() == GameScreen.gameScreen.someYCellPos,
						var9.planetCoords == this.var_b81);
			} else {
				this.sub_689(var1, var7 + var9.getXAbsoluteSector() * this.var_efa,
						var8 + var9.getYAbsoluteSector() * this.var_efa, var5, this.var_efa,
						var9.getXAbsoluteSector() == GameScreen.gameScreen.someXCellPos
								&& var9.getYAbsoluteSector() == GameScreen.gameScreen.someYCellPos,
						var9.planetCoords == this.var_b81);
	...
	public void sub_69b(Graphics var1, int var2, int var3) {
		Planet var4 = GameScreen.gameScreen.sub_76d(GameScreen.gameScreen.someXCellPos,
				GameScreen.gameScreen.someYCellPos);
		if (var4 != null && var4.var_1df != null && var4.sub_150(GameScreen.gameScreen.var_d5c.var_1c6)
				&& var4.var_1df.sub_184()) {
			var1.drawImage(this.artefact, this.var_e96 - 8, var3 + 4, 20);
		}

		int var5 = GameScreen.gameScreen.sub_1592(GameScreen.gameScreen.someXCellPos,
				GameScreen.gameScreen.someYCellPos);
		if (var5 != 0) {
			...
			if (var6 != null) {
				if (var6.var_27d) {
					...
					SomeUtilClass.drawSomeLittleFigure(var1, var2, var3 + 4,
							GameScreen.gameScreen.sub_121c(var6.sub_236()));
				}
	...
	public void sub_72d(Graphics g2) {
		...
		for (var7 = this.var_368; var7 < this.var_b2b + this.var_368; ++var7) {
			...
			for (int var9 = 0; var9 < this.var_cbe; ++var9) {
				...
				if (var11 != null) {
					...
					GameScreen.gameScreen.sub_240c(g2, var8, var5, var10, var11.sub_236(), 30, var11.sub_599(),
							(Image) null);
					GameScreen.gameScreen.sub_fcf(g2, var8 + 3, var5 + 3, "" + var11.sub_264(),
							GameScreen.gameScreen.rMiniFrontImg);
					this.sub_73d(g2, var8 + 4, var5 + 26, var11.var_195);
					this.sub_5de(g2, var8 + 24, var5 + 5, var11.var_1ef);
					if (var11.sub_105()) {
						GameScreen.gameScreen.sub_fcf(g2, var8 + 5, var5 + 19, SomeUtilClass.getStr("А"),
								GameScreen.gameScreen.rMiniFrontImg);
					}
		...
		if (var11 != null) {
			...
			GameScreen.gameScreen.sub_fcf(g2, var2 + 7, var3 + this.var_cea + 8, var11.sub_64d(),
					GameScreen.gameScreen.rMiniFront2Img);
		}
	...
	public void sub_788(Graphics g, int var2, int var3, int var4, int var5) {
		...
		g.drawImage(this.rPanelImg, var6 - this.rPanelImg.getWidth() + 48, var3 + var5 - this.rPanelImg.getHeight(),
				20);
	...
	public void sub_806(Graphics var1, Class_4f2 var2, boolean var3) {
		...
		if (var3 && var2 != null) {
			...
			if (this.var_cd3 == 120) {
				...
				GameScreen.gameScreen.sub_fcf(var1, 1, var4 + 5, SomeUtilClass.getStr("ИМЯ"),
						GameScreen.gameScreen.rMiniFront2Img);
			}
	...
	public void drawNextDateWindow(Graphics g, int xPos, int yPos, int height) {
		...
		GameScreen.gameScreen.drawFancyText(g, xPos + 8, yPos + 11,
				GameScreen.gameScreen.gameCurrentMonth + "." + GameScreen.gameScreen.gameCurrentYear, this.var_42f);
		if (height > 30) {
			g.setColor(0);
			int var5 = yPos + 21;
	...
	public Image sub_988() {
		...
		for (int var6 = 0; var6 < this.var_53a.sub_6d1(); ++var6) {
			...
			SomeUtilClass.drawLittleTextInRect2(var4, this.var_53a.sub_777(var6), 19, var5, var2 + 19, var1);
	...
	public void drawMainMenu(Graphics g) {
		...
		if (GameScreen.gameScreen.var_1730) {
			...
			SomeUtilClass.drawLittleTextInRect2(g, GameScreen.gameScreen.var_1807, 5,
					this.windowHeight - GameScreen.gameScreen.var_1759, this.var_124 - 5, this.windowHeight + 10);
		} else {
	...
	public void drawMainMenu(Graphics g, int xPos, int yPos, int mainMenuLength, int mainMenuHeight) {// походу рисует
																										// главное меню
		g.setColor(1052688);
	...
	public void sub_b76(Graphics var1) {
		...
		for (int var5 = 0; var5 < GameScreen.gameScreen.var_164f.length - 1; ++var5) {
			boolean var6 = false;
			if (GameScreen.gameScreen.var_164f[var5].price > 0) {
				int var11 = GameScreen.gameScreen.var_164f[var5].price;
			...
			var2 = "" + GameScreen.gameScreen.var_164f[var5].price;
	...
	public void sub_bbd(Graphics var1) {
		...
		GameScreen.gameScreen.drawFancyText(var1, 4, this.windowHeight - 10, SomeUtilClass.getStr("НАЗАД"),
				this.var_42f);
	...
	public void sub_c15(Graphics var1, int var2, int var3, int var4) {
		...
		GameScreen.gameScreen.sub_fcf(var1, var2 + 2, var8 + 2, SomeUtilClass.getStr("ИМЯ"),
				GameScreen.gameScreen.rMiniFront2Img);
		var1.setColor(2171169);
		var1.drawLine(var2, var8 + 9, var2 + var4 - 5, var8 + 9);
		int var9 = var2 + var4 - 10 - GameScreen.gameScreen.var_1819.playerGroupName.length() * 8;
		GameScreen.gameScreen.drawFancyText(var1, var9, var8, GameScreen.gameScreen.var_1819.playerGroupName,
				this.var_42f);
		var8 += 11;
		if (this.var_3c8 == 1) {
			this.sub_8d8(var1, var2 - 4, var8 - 7, var4 - 6, this.blueLineImg);
		...
		GameScreen.gameScreen.sub_fcf(var1, var2 + 2, var8 + 2, SomeUtilClass.getStr("СПЕЦИАЛИЗАЦИЯ"),
				GameScreen.gameScreen.rMiniFront2Img);
		...
		var8 += 11;
		GameScreen.gameScreen.drawFancyText(var1, var2 + 2 + 10, var8, SomeUtilClass.getStr("ГРУППИРОВКИ"),
				this.var_42f);
		var1.setColor(2171169);
		var1.drawLine(var2, var8 + 8, var2 + var4 - 5, var8 + 8);
		var1.setColor(5329747);
		...
		GameScreen.gameScreen.sub_fcf(var1, var2 + 2, var8 + 2, SomeUtilClass.getStr("КОЛИЧЕСТВО"),
				GameScreen.gameScreen.rMiniFront2Img);
		...
		GameScreen.gameScreen.sub_fcf(var1, var2 + 2, var8 + 2, SomeUtilClass.getStr("УРОВЕНЬ"),
				GameScreen.gameScreen.rMiniFront2Img);
	...
	public void sub_c45(Graphics var1) {
		...
		var1.drawLine(this.xPos + this.var_124 - 5 - 7, this.yPos + 20, this.xPos + this.var_124 - 5 - 7,
				this.yPos + 30);
		...
		for (int var6 = 1; var6 < 6; ++var6) {
			var1.drawLine(this.xPos + 6 + 5 + var6 * (var4 / 5), this.yPos + 20, this.xPos + 6 + 5 + var6 * (var4 / 5),
					this.yPos + 30);
			...
			GameScreen.gameScreen.sub_fcf(var1, this.xPos + 6 + 5 + (var6 - 1) * (var4 / 5) + 3, this.yPos + 23,
					"" + var6 * 10, var7);
		}
	...
	public void sub_c52(Graphics var1) {
		...
		for (var4 = 0; var4 < this.var_e03.length + 1; ++var4) {
			var1.setColor(2171169);
			var1.drawLine(this.xPos + 4, this.yPos + 20 + var4 * 11, this.xPos + this.var_124 - 5,
					this.yPos + 20 + var4 * 11);
			if (var4 < this.var_e03.length) {
				Class_2a9 var5 = GameScreen.gameScreen.sub_122a(this.var_e03[var4]);
				GameScreen.gameScreen.drawFancyText(var1, this.xPos + 6, this.yPos + 20 + var4 * 11 + 2,
						var5.playerGroupName, this.var_42f);
	...
	public void sub_c74(Graphics var1) {
		...
		GameScreen.gameScreen.drawFancyText(var1, this.xPos + (this.var_124 - var2.length() * 8) / 2, this.yPos + 5,
				var2, this.var_42f);
	...
	public Image sub_cd5() {
		...
		SomeUtilClass.drawLittleTextInRect2(var4, GameScreen.gameScreen.var_1965, 0, 0, var1, var2);
		return var3;
	}
}
